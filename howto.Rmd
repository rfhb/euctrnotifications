...
These notifications are based on services on the internet that offer to generate emails from a newsfeed such as prepared in step 1. There are a number of such services on the internet, some are free and some do not require registration. Such as service is here to exemplify the principle but others can be used and this example does not imply any recommendation. 
