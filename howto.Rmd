...
This how-to can in principle also be used with other trial registers, for example the [U.S. Clinical Trials Register](https://clinicaltrials.gov/ct2/resources/rss#RSSFeedForSpecificSearch). 
...
- The clipboard of the computer now contains the link to a newsfeed for this search. It will be used in the next steps.  
![copyurl](euctr1.jpg)
